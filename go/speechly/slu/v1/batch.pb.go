...
var file_speechly_slu_v1_batch_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x64, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x70, 0x65,
	0x65, 0x63, 0x68, 0x6c, 0x79, 0x2e, 0x73, 0x6c, 0x75, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x42, 0x61,
	0x74, 0x63, 0x68, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x15, 0x73, 0x70, 0x65, 0x65,
...
var file_speechly_slu_v1_batch_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_speechly_slu_v1_batch_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_speechly_slu_v1_batch_proto_goTypes = []interface{}{
	...
	(*AudioConfiguration)(nil),       // 2: speechly.slu.v1.AudioConfiguration
	(*Operation)(nil),                // 3: speechly.slu.v1.Operation
	(*Transcript)(nil),               // 4: speechly.slu.v1.Transcript
...
var file_speechly_slu_v1_batch_proto_depIdxs = []int32{
	...
	1, // 1: speechly.slu.v1.Operation.status:type_name -> speechly.slu.v1.Operation.Status
	4, // 2: speechly.slu.v1.Operation.transcripts:type_name -> speechly.slu.v1.Transcript
