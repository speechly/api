...
const (
	BatchAPI_ProcessAudioSource_FullMethodName = "/speechly.slu.v2beta1.BatchAPI/ProcessAudioSource"
	BatchAPI_QueryStatus_FullMethodName        = "/speechly.slu.v2beta1.BatchAPI/QueryStatus"
)
