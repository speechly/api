...
const (
	ModelAPI_DownloadModel_FullMethodName  = "/speechly.config.v1.ModelAPI/DownloadModel"
	ModelAPI_ListBaseModels_FullMethodName = "/speechly.config.v1.ModelAPI/ListBaseModels"
	ModelAPI_ListLanguages_FullMethodName  = "/speechly.config.v1.ModelAPI/ListLanguages"
)
...
func (c *modelAPIClient) DownloadModel(ctx context.Context, in *DownloadModelRequest, opts ...grpc.CallOption) (ModelAPI_DownloadModelClient, error) {
	stream, err := c.cc.NewStream(ctx, &ModelAPI_ServiceDesc.Streams[0], ModelAPI_DownloadModel_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *modelAPIClient) ListBaseModels(ctx context.Context, in *ListBaseModelsRequest, opts ...grpc.CallOption) (*ListBaseModelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ModelAPI_ListBaseModels_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *modelAPIClient) ListLanguages(ctx context.Context, in *ListLanguagesRequest, opts ...grpc.CallOption) (*ListLanguagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ModelAPI_ListLanguages_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ModelAPI_ListBaseModels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ModelAPI_ListBaseModels_FullMethodName,
	}
...
func _ModelAPI_ListLanguages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ModelAPI_ListLanguages_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
