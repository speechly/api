...
func (c *compilerClient) Compile(ctx context.Context, opts ...grpc.CallOption) (Compiler_CompileClient, error) {
	stream, err := c.cc.NewStream(ctx, &Compiler_ServiceDesc.Streams[0], "/speechly.sal.v1.Compiler/Compile", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *compilerClient) Validate(ctx context.Context, opts ...grpc.CallOption) (Compiler_ValidateClient, error) {
	stream, err := c.cc.NewStream(ctx, &Compiler_ServiceDesc.Streams[1], "/speechly.sal.v1.Compiler/Validate", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *compilerClient) ExtractSALSources(ctx context.Context, opts ...grpc.CallOption) (Compiler_ExtractSALSourcesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Compiler_ServiceDesc.Streams[2], "/speechly.sal.v1.Compiler/ExtractSALSources", opts...)
	if err != nil {
		return nil, err
	}
