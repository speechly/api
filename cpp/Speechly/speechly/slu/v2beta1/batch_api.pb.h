...
#ifndef GOOGLE_PROTOBUF_INCLUDED_speechly_2fslu_2fv2beta1_2fbatch_5fapi_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_speechly_2fslu_2fv2beta1_2fbatch_5fapi_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_speechly_2fslu_2fv2beta1_2fbatch_5fapi_2eproto;
namespace speechly {
namespace slu {
namespace v2beta1 {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::speechly::slu::v2beta1::ProcessAudioSourceRequest* Arena::CreateMaybeMessage<::speechly::slu::v2beta1::ProcessAudioSourceRequest>(Arena*);
template<> ::speechly::slu::v2beta1::ProcessAudioSourceResponse* Arena::CreateMaybeMessage<::speechly::slu::v2beta1::ProcessAudioSourceResponse>(Arena*);
template<> ::speechly::slu::v2beta1::QueryStatusRequest* Arena::CreateMaybeMessage<::speechly::slu::v2beta1::QueryStatusRequest>(Arena*);
template<> ::speechly::slu::v2beta1::QueryStatusResponse* Arena::CreateMaybeMessage<::speechly::slu::v2beta1::QueryStatusResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace speechly {
namespace slu {
namespace v2beta1 {
...
class ProcessAudioSourceRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:speechly.slu.v2beta1.ProcessAudioSourceRequest) */ {
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem >*
      mutable_source();
  private:
  const ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem& _internal_source(int index) const;
  ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem* _internal_add_source();
  public:
...
class ProcessAudioSourceResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:speechly.slu.v2beta1.ProcessAudioSourceResponse) */ {
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::speechly::slu::v2beta1::Operation >*
      mutable_operation();
  private:
  const ::speechly::slu::v2beta1::Operation& _internal_operation(int index) const;
  ::speechly::slu::v2beta1::Operation* _internal_add_operation();
  public:
  const ::speechly::slu::v2beta1::Operation& operation(int index) const;
  ::speechly::slu::v2beta1::Operation* add_operation();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::speechly::slu::v2beta1::Operation >&
      operation() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::speechly::slu::v2beta1::Operation > operation_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_speechly_2fslu_2fv2beta1_2fbatch_5fapi_2eproto;
};
// -------------------------------------------------------------------
...
class QueryStatusRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:speechly.slu.v2beta1.QueryStatusRequest) */ {
 public:
...
class QueryStatusResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:speechly.slu.v2beta1.QueryStatusResponse) */ {
 public:
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem >*
...
inline const ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem& ProcessAudioSourceRequest::_internal_source(int index) const {
...
inline ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem* ProcessAudioSourceRequest::_internal_add_source() {
  return source_.Add();
}
inline ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem* ProcessAudioSourceRequest::add_source() {
  ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem* _add = _internal_add_source();
  // @@protoc_insertion_point(field_add:speechly.slu.v2beta1.ProcessAudioSourceRequest.source)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem >&
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::speechly::slu::v2beta1::Operation >*
...
inline const ::speechly::slu::v2beta1::Operation& ProcessAudioSourceResponse::_internal_operation(int index) const {
...
inline ::speechly::slu::v2beta1::Operation* ProcessAudioSourceResponse::_internal_add_operation() {
  return operation_.Add();
}
inline ::speechly::slu::v2beta1::Operation* ProcessAudioSourceResponse::add_operation() {
  ::speechly::slu::v2beta1::Operation* _add = _internal_add_operation();
  // @@protoc_insertion_point(field_add:speechly.slu.v2beta1.ProcessAudioSourceResponse.operation)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::speechly::slu::v2beta1::Operation >&
...
inline const ::speechly::slu::v2beta1::Operation& QueryStatusResponse::_internal_operation(int index) const {
  return operation_.Get(index);
}
...
inline ::speechly::slu::v2beta1::Operation* QueryStatusResponse::_internal_add_operation() {
  return operation_.Add();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_speechly_2fslu_2fv2beta1_2fbatch_5fapi_2eproto
