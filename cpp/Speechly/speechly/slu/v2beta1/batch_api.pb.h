...
#ifndef GOOGLE_PROTOBUF_INCLUDED_speechly_2fslu_2fv2beta1_2fbatch_5fapi_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_speechly_2fslu_2fv2beta1_2fbatch_5fapi_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_speechly_2fslu_2fv2beta1_2fbatch_5fapi_2eproto
...
struct TableStruct_speechly_2fslu_2fv2beta1_2fbatch_5fapi_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_speechly_2fslu_2fv2beta1_2fbatch_5fapi_2eproto;
namespace speechly {
namespace slu {
namespace v2beta1 {
...
class ProcessAudioSourceRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:speechly.slu.v2beta1.ProcessAudioSourceRequest) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "speechly.slu.v2beta1.ProcessAudioSourceRequest";
  }
  protected:
  ...
  public:
  void clear_source() ;
  ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem* mutable_source(int index);
  ::google::protobuf::RepeatedPtrField< ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem >*
      mutable_source();
  private:
  const ::google::protobuf::RepeatedPtrField<::speechly::slu::v2beta1::ProcessAudioSourceRequestItem>& _internal_source() const;
  ::google::protobuf::RepeatedPtrField<::speechly::slu::v2beta1::ProcessAudioSourceRequestItem>* _internal_mutable_source();
  public:
  const ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem& source(int index) const;
  ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem* add_source();
  const ::google::protobuf::RepeatedPtrField< ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem >&
      source() const;
  // .speechly.slu.v2beta1.ProcessAudioBatchConfig config = 1;
  bool has_config() const;
  void clear_config() ;
  const ::speechly::slu::v2beta1::ProcessAudioBatchConfig& config() const;
  PROTOBUF_NODISCARD ::speechly::slu::v2beta1::ProcessAudioBatchConfig* release_config();
  ::speechly::slu::v2beta1::ProcessAudioBatchConfig* mutable_config();
  void set_allocated_config(::speechly::slu::v2beta1::ProcessAudioBatchConfig* value);
  void unsafe_arena_set_allocated_config(::speechly::slu::v2beta1::ProcessAudioBatchConfig* value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedPtrField< ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem > source_;
...
class ProcessAudioSourceResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:speechly.slu.v2beta1.ProcessAudioSourceResponse) */ {
 public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "speechly.slu.v2beta1.ProcessAudioSourceResponse";
  }
  protected:
  ...
  ::speechly::slu::v2beta1::Operation* mutable_operation(int index);
  ::google::protobuf::RepeatedPtrField< ::speechly::slu::v2beta1::Operation >*
      mutable_operation();
  private:
  const ::google::protobuf::RepeatedPtrField<::speechly::slu::v2beta1::Operation>& _internal_operation() const;
  ::google::protobuf::RepeatedPtrField<::speechly::slu::v2beta1::Operation>* _internal_mutable_operation();
  public:
  const ::speechly::slu::v2beta1::Operation& operation(int index) const;
  ::speechly::slu::v2beta1::Operation* add_operation();
  const ::google::protobuf::RepeatedPtrField< ::speechly::slu::v2beta1::Operation >&
      operation() const;
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::google::protobuf::RepeatedPtrField< ::speechly::slu::v2beta1::Operation > operation_;
    mutable ::google::protobuf::internal::CachedSize _cached_size_;
    PROTOBUF_TSAN_DECLARE_MEMBER;
  };
  union { Impl_ _impl_; };
...
class QueryStatusRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:speechly.slu.v2beta1.QueryStatusRequest) */ {
 public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "speechly.slu.v2beta1.QueryStatusRequest";
  }
  protected:
...
class QueryStatusResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:speechly.slu.v2beta1.QueryStatusResponse) */ {
 public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "speechly.slu.v2beta1.QueryStatusResponse";
  }
  protected:
...
inline const ::speechly::slu::v2beta1::ProcessAudioBatchConfig& ProcessAudioSourceRequest::_internal_config() const {
  ...
  const ::speechly::slu::v2beta1::ProcessAudioBatchConfig* p = _impl_.config_;
  return p != nullptr ? *p : reinterpret_cast<const ::speechly::slu::v2beta1::ProcessAudioBatchConfig&>(::speechly::slu::v2beta1::_ProcessAudioBatchConfig_default_instance_);
}
...
inline void ProcessAudioSourceRequest::unsafe_arena_set_allocated_config(::speechly::slu::v2beta1::ProcessAudioBatchConfig* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.config_);
  }
  _impl_.config_ = reinterpret_cast<::speechly::slu::v2beta1::ProcessAudioBatchConfig*>(value);
  if (value != nullptr) {
...
inline ::speechly::slu::v2beta1::ProcessAudioBatchConfig* ProcessAudioSourceRequest::release_config() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::speechly::slu::v2beta1::ProcessAudioBatchConfig* released = _impl_.config_;
...
inline ::speechly::slu::v2beta1::ProcessAudioBatchConfig* ProcessAudioSourceRequest::unsafe_arena_release_config() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  ::speechly::slu::v2beta1::ProcessAudioBatchConfig* temp = _impl_.config_;
  _impl_.config_ = nullptr;
  return temp;
}
inline ::speechly::slu::v2beta1::ProcessAudioBatchConfig* ProcessAudioSourceRequest::_internal_mutable_config() {
  ...
  if (_impl_.config_ == nullptr) {
    ...
    _impl_.config_ = reinterpret_cast<::speechly::slu::v2beta1::ProcessAudioBatchConfig*>(p);
  }
...
inline void ProcessAudioSourceRequest::set_allocated_config(::speechly::slu::v2beta1::ProcessAudioBatchConfig* value) {
...
inline ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem* ProcessAudioSourceRequest::mutable_source(int index) {
  // @@protoc_insertion_point(field_mutable:speechly.slu.v2beta1.ProcessAudioSourceRequest.source)
  return _internal_mutable_source()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem >*
ProcessAudioSourceRequest::mutable_source() {
  // @@protoc_insertion_point(field_mutable_list:speechly.slu.v2beta1.ProcessAudioSourceRequest.source)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_source();
}
inline const ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem& ProcessAudioSourceRequest::source(int index) const {
  // @@protoc_insertion_point(field_get:speechly.slu.v2beta1.ProcessAudioSourceRequest.source)
    return _internal_source().Get(index);
}
inline ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem* ProcessAudioSourceRequest::add_source() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem* _add = _internal_mutable_source()->Add();
  // @@protoc_insertion_point(field_add:speechly.slu.v2beta1.ProcessAudioSourceRequest.source)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField< ::speechly::slu::v2beta1::ProcessAudioSourceRequestItem >&
ProcessAudioSourceRequest::source() const {
  // @@protoc_insertion_point(field_list:speechly.slu.v2beta1.ProcessAudioSourceRequest.source)
...
inline ::speechly::slu::v2beta1::Operation* ProcessAudioSourceResponse::mutable_operation(int index) {
  // @@protoc_insertion_point(field_mutable:speechly.slu.v2beta1.ProcessAudioSourceResponse.operation)
  return _internal_mutable_operation()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::speechly::slu::v2beta1::Operation >*
ProcessAudioSourceResponse::mutable_operation() {
  // @@protoc_insertion_point(field_mutable_list:speechly.slu.v2beta1.ProcessAudioSourceResponse.operation)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_operation();
}
inline const ::speechly::slu::v2beta1::Operation& ProcessAudioSourceResponse::operation(int index) const {
  // @@protoc_insertion_point(field_get:speechly.slu.v2beta1.ProcessAudioSourceResponse.operation)
    return _internal_operation().Get(index);
}
inline ::speechly::slu::v2beta1::Operation* ProcessAudioSourceResponse::add_operation() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::speechly::slu::v2beta1::Operation* _add = _internal_mutable_operation()->Add();
  // @@protoc_insertion_point(field_add:speechly.slu.v2beta1.ProcessAudioSourceResponse.operation)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField< ::speechly::slu::v2beta1::Operation >&
ProcessAudioSourceResponse::operation() const {
  // @@protoc_insertion_point(field_list:speechly.slu.v2beta1.ProcessAudioSourceResponse.operation)
...
inline std::string* QueryStatusRequest::add_operation_ids() {
  ...
  // @@protoc_insertion_point(field_add_mutable:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
  return _s;
}
inline const std::string& QueryStatusRequest::operation_ids(int index) const {
  // @@protoc_insertion_point(field_get:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
  return _internal_operation_ids().Get(index);
}
inline std::string* QueryStatusRequest::mutable_operation_ids(int index) {
  // @@protoc_insertion_point(field_mutable:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
...
inline void QueryStatusRequest::set_operation_ids(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
}
...
inline void QueryStatusRequest::set_operation_ids(int index, const char* value) {
  ...
  _internal_mutable_operation_ids()->Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
}
inline void QueryStatusRequest::set_operation_ids(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_operation_ids()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
}
inline void QueryStatusRequest::set_operation_ids(int index, absl::string_view value) {
  _internal_mutable_operation_ids()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
}
inline void QueryStatusRequest::add_operation_ids(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_operation_ids()->Add()->assign(value);
  // @@protoc_insertion_point(field_add:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
}
...
inline void QueryStatusRequest::add_operation_ids(const char* value) {
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_operation_ids()->Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
}
inline void QueryStatusRequest::add_operation_ids(const char* value, std::size_t size) {
  ...
  _internal_mutable_operation_ids()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
}
inline void QueryStatusRequest::add_operation_ids(absl::string_view value) {
  ...
  // @@protoc_insertion_point(field_add_string_piece:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
}
inline const ::google::protobuf::RepeatedPtrField<std::string>&
QueryStatusRequest::operation_ids() const {
  // @@protoc_insertion_point(field_list:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
...
inline ::google::protobuf::RepeatedPtrField<std::string>* QueryStatusRequest::mutable_operation_ids() {
  // @@protoc_insertion_point(field_mutable_list:speechly.slu.v2beta1.QueryStatusRequest.operation_ids)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
...
inline std::string* QueryStatusRequest::add_operation_references() {
  ...
  // @@protoc_insertion_point(field_add_mutable:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
  return _s;
}
inline const std::string& QueryStatusRequest::operation_references(int index) const {
  // @@protoc_insertion_point(field_get:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
...
inline std::string* QueryStatusRequest::mutable_operation_references(int index) {
  // @@protoc_insertion_point(field_mutable:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
...
inline void QueryStatusRequest::set_operation_references(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
}
...
inline void QueryStatusRequest::set_operation_references(int index, const char* value) {
  ABSL_DCHECK(value != nullptr);
  _internal_mutable_operation_references()->Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
}
inline void QueryStatusRequest::set_operation_references(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_operation_references()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
}
inline void QueryStatusRequest::set_operation_references(int index, absl::string_view value) {
  _internal_mutable_operation_references()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
}
inline void QueryStatusRequest::add_operation_references(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
}
...
inline void QueryStatusRequest::add_operation_references(const char* value) {
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_operation_references()->Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
}
inline void QueryStatusRequest::add_operation_references(const char* value, std::size_t size) {
  ...
  _internal_mutable_operation_references()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
}
inline void QueryStatusRequest::add_operation_references(absl::string_view value) {
  ...
  // @@protoc_insertion_point(field_add_string_piece:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
}
inline const ::google::protobuf::RepeatedPtrField<std::string>&
QueryStatusRequest::operation_references() const {
  // @@protoc_insertion_point(field_list:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
...
inline ::google::protobuf::RepeatedPtrField<std::string>* QueryStatusRequest::mutable_operation_references() {
  // @@protoc_insertion_point(field_mutable_list:speechly.slu.v2beta1.QueryStatusRequest.operation_references)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
...
inline const std::string& QueryStatusRequest::batch_id() const {
  // @@protoc_insertion_point(field_get:speechly.slu.v2beta1.QueryStatusRequest.batch_id)
...
inline PROTOBUF_ALWAYS_INLINE void QueryStatusRequest::set_batch_id(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:speechly.slu.v2beta1.QueryStatusRequest.batch_id)
}
inline std::string* QueryStatusRequest::mutable_batch_id() {
  std::string* _s = _internal_mutable_batch_id();
  // @@protoc_insertion_point(field_mutable:speechly.slu.v2beta1.QueryStatusRequest.batch_id)
  return _s;
}
...
inline std::string* QueryStatusRequest::release_batch_id() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:speechly.slu.v2beta1.QueryStatusRequest.batch_id)
...
inline void QueryStatusRequest::set_allocated_batch_id(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:speechly.slu.v2beta1.QueryStatusRequest.batch_id)
}
...
inline const std::string& QueryStatusRequest::batch_reference() const {
  // @@protoc_insertion_point(field_get:speechly.slu.v2beta1.QueryStatusRequest.batch_reference)
...
inline PROTOBUF_ALWAYS_INLINE void QueryStatusRequest::set_batch_reference(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:speechly.slu.v2beta1.QueryStatusRequest.batch_reference)
}
inline std::string* QueryStatusRequest::mutable_batch_reference() {
  std::string* _s = _internal_mutable_batch_reference();
  // @@protoc_insertion_point(field_mutable:speechly.slu.v2beta1.QueryStatusRequest.batch_reference)
  return _s;
}
...
inline std::string* QueryStatusRequest::release_batch_reference() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:speechly.slu.v2beta1.QueryStatusRequest.batch_reference)
...
inline void QueryStatusRequest::set_allocated_batch_reference(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:speechly.slu.v2beta1.QueryStatusRequest.batch_reference)
}
...
inline ::speechly::slu::v2beta1::Operation* QueryStatusResponse::mutable_operation(int index) {
  // @@protoc_insertion_point(field_mutable:speechly.slu.v2beta1.QueryStatusResponse.operation)
  return _internal_mutable_operation()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::speechly::slu::v2beta1::Operation >*
QueryStatusResponse::mutable_operation() {
  // @@protoc_insertion_point(field_mutable_list:speechly.slu.v2beta1.QueryStatusResponse.operation)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_operation();
}
inline const ::speechly::slu::v2beta1::Operation& QueryStatusResponse::operation(int index) const {
  // @@protoc_insertion_point(field_get:speechly.slu.v2beta1.QueryStatusResponse.operation)
    return _internal_operation().Get(index);
}
inline ::speechly::slu::v2beta1::Operation* QueryStatusResponse::add_operation() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::speechly::slu::v2beta1::Operation* _add = _internal_mutable_operation()->Add();
  // @@protoc_insertion_point(field_add:speechly.slu.v2beta1.QueryStatusResponse.operation)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField< ::speechly::slu::v2beta1::Operation >&
QueryStatusResponse::operation() const {
  // @@protoc_insertion_point(field_list:speechly.slu.v2beta1.QueryStatusResponse.operation)
  return _internal_operation();
}
inline const ::google::protobuf::RepeatedPtrField<::speechly::slu::v2beta1::Operation>&
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_speechly_2fslu_2fv2beta1_2fbatch_5fapi_2eproto_2epb_2eh
