...
class HttpRule final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_response_body();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_get();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_put();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_delete_();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::CustomHttpPattern* release_custom();
