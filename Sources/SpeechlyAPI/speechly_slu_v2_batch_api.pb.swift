...
public struct Speechly_Slu_V2_ProcessAudioSourceRequest {
  ...
  public var tasks: Speechly_Slu_V2_BatchTasks {
    get {return _tasks ?? Speechly_Slu_V2_BatchTasks()}
    set {_tasks = newValue}
  }
  ...
  /// Optional.
  public var config: Speechly_Slu_V2_BatchConfig {
    get {return _config ?? Speechly_Slu_V2_BatchConfig()}
  ...
  public var output: Speechly_Slu_V2_BatchOutput {
    get {return _output ?? Speechly_Slu_V2_BatchOutput()}
  ...
  public var source: [Speechly_Slu_V2_ProcessAudioSourceRequestItem] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _tasks: Speechly_Slu_V2_BatchTasks? = nil
  fileprivate var _config: Speechly_Slu_V2_BatchConfig? = nil
  fileprivate var _output: Speechly_Slu_V2_BatchOutput? = nil
}

/// Describes a response to request to process audio from a pre-existing source.
public struct Speechly_Slu_V2_ProcessAudioSourceResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The details of the created operations.
  public var operation: [Speechly_Slu_V2_Operation] = []
...
public struct Speechly_Slu_V2_QueryStatusRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Speechly_Slu_V2_QueryStatusResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Speechly_Slu_V2_ProcessAudioSourceRequest: @unchecked Sendable {}
extension Speechly_Slu_V2_ProcessAudioSourceResponse: @unchecked Sendable {}
extension Speechly_Slu_V2_QueryStatusRequest: @unchecked Sendable {}
extension Speechly_Slu_V2_QueryStatusResponse: @unchecked Sendable {}
...
extension Speechly_Slu_V2_ProcessAudioSourceRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Speechly_Slu_V2_ProcessAudioSourceRequest, rhs: Speechly_Slu_V2_ProcessAudioSourceRequest) -> Bool {
...
extension Speechly_Slu_V2_ProcessAudioSourceResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Speechly_Slu_V2_ProcessAudioSourceResponse, rhs: Speechly_Slu_V2_ProcessAudioSourceResponse) -> Bool {
...
extension Speechly_Slu_V2_QueryStatusRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Speechly_Slu_V2_QueryStatusRequest, rhs: Speechly_Slu_V2_QueryStatusRequest) -> Bool {
...
extension Speechly_Slu_V2_QueryStatusResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Speechly_Slu_V2_QueryStatusResponse, rhs: Speechly_Slu_V2_QueryStatusResponse) -> Bool {
    if lhs.operation != rhs.operation {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
