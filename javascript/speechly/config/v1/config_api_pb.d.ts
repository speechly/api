...
export class GetProjectResponse extends jspb.Message { 
    ...
    setProjectList(value: Array<string>): GetProjectResponse;
    addProject(value: string, index?: number): string;

    clearProjectNamesList(): void;
    getProjectNamesList(): Array<string>;
    setProjectNamesList(value: Array<string>): GetProjectResponse;
...
export class CreateProjectResponse extends jspb.Message { 
    getProject(): string;
    setProject(value: string): CreateProjectResponse;
...
export class UpdateProjectRequest extends jspb.Message { 
    getProject(): string;
    setProject(value: string): UpdateProjectRequest;
...
export class GetProjectParticipantsRequest extends jspb.Message { 
    getProject(): string;
    setProject(value: string): GetProjectParticipantsRequest;
...
export class GetProjectParticipantsResponse extends jspb.Message { 
    ...
    setParticipantsList(value: Array<GetProjectParticipantsResponse.Participant>): GetProjectParticipantsResponse;
...
export namespace GetProjectParticipantsResponse {
    ...
    export class Participant extends jspb.Message { 
        getName(): string;
        setName(value: string): Participant;

        getEmail(): string;
        setEmail(value: string): Participant;

        getId(): string;
        setId(value: string): Participant;
...
export class InviteRequest extends jspb.Message { 
    getProject(): string;
    setProject(value: string): InviteRequest;
...
export class InviteResponse extends jspb.Message { 
    ...
    setInvitationToken(value: string): InviteResponse;
...
export class JoinProjectRequest extends jspb.Message { 
    getInvitationToken(): string;
    setInvitationToken(value: string): JoinProjectRequest;
...
export class ListAppsRequest extends jspb.Message { 
    getProject(): string;
    setProject(value: string): ListAppsRequest;
...
export class GetAppRequest extends jspb.Message { 
    getAppId(): string;
    setAppId(value: string): GetAppRequest;
...
export class GetAppResponse extends jspb.Message { 
    ...
    setApp(value?: App): GetAppResponse;
...
export class CreateAppRequest extends jspb.Message { 
    getProject(): string;
    setProject(value: string): CreateAppRequest;
...
export class DeleteAppRequest extends jspb.Message { 
    getAppId(): string;
    setAppId(value: string): DeleteAppRequest;
...
export class UploadTrainingDataRequest extends jspb.Message { 
    getAppId(): string;
    setAppId(value: string): UploadTrainingDataRequest;

    getDataChunk(): Uint8Array | string;
    getDataChunk_asU8(): Uint8Array;
    getDataChunk_asB64(): string;
    setDataChunk(value: Uint8Array | string): UploadTrainingDataRequest;

    getContentType(): UploadTrainingDataRequest.ContentType;
    setContentType(value: UploadTrainingDataRequest.ContentType): UploadTrainingDataRequest;
...
export namespace UploadTrainingDataRequest {
    export type AsObject = {
        ...
        contentType: UploadTrainingDataRequest.ContentType,
    }
...
export class DownloadCurrentTrainingDataRequest extends jspb.Message { 
    getAppId(): string;
    setAppId(value: string): DownloadCurrentTrainingDataRequest;

    getConfigId(): string;
    setConfigId(value: string): DownloadCurrentTrainingDataRequest;
...
export class DownloadCurrentTrainingDataResponse extends jspb.Message { 
    ...
    getDataChunk_asU8(): Uint8Array;
    getDataChunk_asB64(): string;
    setDataChunk(value: Uint8Array | string): DownloadCurrentTrainingDataResponse;

    getContentType(): DownloadCurrentTrainingDataResponse.ContentType;
    setContentType(value: DownloadCurrentTrainingDataResponse.ContentType): DownloadCurrentTrainingDataResponse;
...
export namespace DownloadCurrentTrainingDataResponse {
    export type AsObject = {
        dataChunk: Uint8Array | string,
        contentType: DownloadCurrentTrainingDataResponse.ContentType,
    }
...
export class App extends jspb.Message { 
    ...
    getQueueSize(): number;
    setQueueSize(value: number): App;

    getErrorMsg(): string;
    setErrorMsg(value: string): App;
